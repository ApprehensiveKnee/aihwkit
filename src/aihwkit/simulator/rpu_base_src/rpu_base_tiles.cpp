...
void declare_rpu_tiles(py::module &m, std::string type_name_add) {
  ...
  py::class_<RPU::WeightQuantizerParameter<T>>(m, NAME("WeightQuantizerParameter"))
      ...
      .def_readwrite("amax_channelwise", &RPU::WeightQuantizerParameter<T>::amax_channelwise)
      .def_readwrite("amax_values", &RPU::WeightQuantizerParameter<T>::amax_values)
      ...
      .def_readwrite("use_inplace", &RPU::WeightQuantizerParameter<T>::use_inplace)
