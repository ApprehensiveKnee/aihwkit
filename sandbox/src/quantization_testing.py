...
def rpu_factory(resolution: float = 0.5,levels: int = 3):
...
ITERABLES = {
    'resolution': [0.5, 0.4, 0.3, 0.2 ,0.1, 0.05],
    'levels': [17, 9, 7, 5, 3],
}
...
def test_quantization():
    ...
    rpu_config = rpu_factory(resolution=0.5, levels=5)
    ...
    plot_quantization_effects('resolution', {'levels': 0}, tile)

    # Plot the effects of different levels on the weights of the tile
    plot_quantization_effects('levels', {'resolution': 0.25}, tile)
