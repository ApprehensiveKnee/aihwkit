...
# drive.mount('/gdrive')
# %cd /gdrive/My Drive/Colab Notebooks/aihwkit/LeNet5
...
# Noise model to be used for the training -> NO PROGRAMMING NOISE, NO DRIFT
...
def load_images():
    ...
    transform_train = transforms.Compose([ transforms.RandomRotation(30),
                                    ...
                                    transforms.ToTensor(),])
    train_set = datasets.MNIST(PATH_DATASET, download=True, train=True, transform=transform_train)
    # Split the train set into train and validation, considering 80% for training and 20% for validation
